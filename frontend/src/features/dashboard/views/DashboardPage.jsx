...
// 👨‍🍳 2. DASHBOARD PARA EMPLEADOS (Local)
// 👨‍🍳 2. DASHBOARD PARA EMPLEADOS (Local)
const EmployeeDashboard = ({ stats, navigate, handleLogout, handleBuscar, handleDownloadPDF }) => {
  const actions = [
    ...
    // 👇 Agregamos de vuelta el botón de Reportes 👇
    { title: 'Reportes y Cortes', icon: FileText, bg: 'bg-emerald-600 border border-emerald-500 shadow-md shadow-emerald-200', onClick: () => navigate('/admin/reports') },
  ];
...
// 🧭 3. WRAPPER PRINCIPAL (Elige cuál mostrar)
const DashboardPage = () => {
  ...
  const handleDownloadPDF = (id) => handlePdfResponse(() => foliosApi.downloadPdf(id));
  ...
  // Si es dueño/admin y quiere ver el HUB
